...
- Name: comprehensive.spec.ts >> Comprehensive Functional Audit >> Job Tracker: CRUD Operations
- Location: e2e\comprehensive.spec.ts:42:7
...
- generic [active] [ref=e1]:
  ...
  - alert [ref=e112]: Land your dream role with AI Intelligence
```
